...
from reports.DeliverySummaryTurnover import get_Delivery_summary_trunover
...
def load_report(content):
    ...
    def generate():
        try:
            ...
            columns, rows = get_Delivery_summary_trunover(*dates)
            show_treeview(content, columns, rows, "DeliverySummary")
