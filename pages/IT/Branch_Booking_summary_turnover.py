...
from reports.BookingSummaryTurnover import get_Booking_summary_trunover
...
def load_report(content):
    ...
    def generate():
        try:
            ...
            columns, rows = get_Booking_summary_trunover(*dates)
            show_treeview(content, columns, rows, "BookingSummary")
