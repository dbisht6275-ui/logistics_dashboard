...
from reports.ZoneWiseDeliveryTurnover import get_zone_wise_delivery_turnover
...
def load_report(content):
    ...
    ctk.CTkLabel(
        frame, 
        text="📊 Zone Wise Delivery Turnover", 
    ...
    def generate():
        try:
            ...
            columns, rows = get_zone_wise_delivery_turnover(*dates)
            
            show_treeview(content, columns, rows, "ZoneWiseDelivery")
