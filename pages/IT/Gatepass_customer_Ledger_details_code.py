...
from reports.GatepassCustomerVoucherDetailscode import get_Gatepass_customer_Ledger_details_code
...
def load_report(content):
    ...
    ctk.CTkLabel(
        frame, 
        text="📊 Gatepass Customer Code Ledger Details", 
    ...
    def generate():
        try:
            ...
            columns, rows = get_Gatepass_customer_Ledger_details_code(from_date, to_date, cnge_code)

            # Show report in Treeview
            show_treeview(content, columns, rows, "Gatepass Customer Code Ledger")
