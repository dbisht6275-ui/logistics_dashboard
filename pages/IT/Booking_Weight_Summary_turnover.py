...
from reports.BookingWeightSummaryTurnover import get_Booking_Weight_Summary_Turnover
...
def load_report(content):
    ...
    ctk.CTkLabel(
        frame, 
        text="📊 Booking Weight Summary Turnover", 
    ...
    def generate():
        try:
            ...
            columns, rows = get_Booking_Weight_Summary_Turnover(*dates)
            show_treeview(content, columns, rows, "BookingWeightSummary")
