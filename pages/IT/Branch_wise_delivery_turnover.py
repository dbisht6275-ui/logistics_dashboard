...
from reports.BranchWiseDeliveryTurnover import get_Branch_wise_delivery_turnover
...
def load_report(content):
    ...
    ctk.CTkLabel(
        frame, 
        text="📊 Branch Wise Delivery Turnover", 
    ...
    def generate():
        try:
            ...
            columns, rows = get_Branch_wise_delivery_turnover(*dates)
            show_treeview(content, columns, rows, "BranchWiseDelivery")
