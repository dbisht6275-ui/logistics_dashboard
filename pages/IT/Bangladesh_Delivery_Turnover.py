...
from reports.BangladeshDeliveryTurnover import get_Bangladesh_Delivery_Turnover
...
def load_report(content):
    ...
    ctk.CTkLabel(
        frame, 
        text="📊 Bangladesh Delivery Turnover", 
    ...
    def generate():
        try:
            ...
            columns, rows = get_Bangladesh_Delivery_Turnover(*dates)
            show_treeview(content, columns, rows, "BangladeshDeliveryTurnover")
